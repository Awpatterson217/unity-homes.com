...
const checkEmailParam = function(req, res, next) {
...
const checkNames = function(req, res, next) {
...
const checkCode = function(req, res, next) {
...
const checkPass = function(req, res, next) {
...
const checkPassTwo = function(req, res, next) {
...
const checkImage = function(req, res, next) {
...
const checkProps = function(req, res, next) {
  let property = {};
...
const checkIdParam = function(req, res, next) {
...
const checkTenantAuth = function(req, res, next) {
  if (!req.session.userAuth)
    return res.redirect('/login');
...
const checkApp = function(req, res, next) {
  let app = {};
