...
const Applicant = function() {
  ...
  this.create = function(callback) {
    ...
    _count('applicant', {
      ...
      if (!count) {
        _create('applicant', dataObj, function(error) {
          if (error !== null)
            return callback(newErr(error));
  ...
  this.delete = function(filter, callback) {
    _delete('applicant', filter, function(error, numOfDeletes) {
      if (error !== null)
        return callback(newErr(error));
  ...
  this.all = async function() {
    try {
      const applicants = await _all('applicant');
  ...
  this.find = async function(filter) {
    ...
    try {
      const applicant = await _find('applicant', filter);
