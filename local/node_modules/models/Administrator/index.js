...
const Administrator = function() {
  ...
  // If it is the first time logging in from admin account
  // create password.
  // When creating admin accounts a temporary password will be generated and emailed.
  this.firstLogin = {
    value   : '',
    required: true,
    safe    : function(str) {
